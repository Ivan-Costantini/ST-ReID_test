...
parser.add_argument('--PRID', action='store_true', help='prepare dataset PRID')
...
if opt.Duke:
    ...
    download_path = "./raw-dataset/DukeMTMC/"



if opt.PRID:
    save_path = "./dataset/PRID_prepare/"
    download_path = "./raw-dataset/PRID2011/"



if not os.path.isdir(download_path):
    print('please change the download_path, currentPath: ', download_path, ' , not found')
    exit()
